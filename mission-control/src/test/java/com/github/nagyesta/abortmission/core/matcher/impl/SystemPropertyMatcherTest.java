...
class SystemPropertyMatcherTest extends AbstractMatcherTest {
    ...
    private static final String NOT_FOUND_PROPERTY_NAME = "CERTAINLY_NOT-FOUND-Env_Var_name-For__Abort-Mission";
    ...
    private static final MissionHealthCheckMatcher NOT_FOUND_VARIABLE_NOT_EMPTY_MATCHER = MissionHealthCheckMatcherBuilder.builder()
            .property(NOT_FOUND_PROPERTY_NAME)
    ...
    private static Stream<Arguments> validInputProvider() {
        return Stream.<Arguments>builder()
                .add(Arguments.of(NOT_FOUND_PROPERTY_NAME, NOT_EMPTY, INT_42, false))
                .add(Arguments.of(PATH, NOT_EMPTY, INT_42, true))
                .add(Arguments.of(NOT_FOUND_PROPERTY_NAME, NOT_EMPTY, NOT_EMPTY, false))
