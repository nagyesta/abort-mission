...
extra.apply {
    set("artifactDisplayName", "Abort Mission - Mission Control")
    set("artifactDescription", "Core module of Abort Mission which is providing flexible test abort options for failing test groups.")
}
