...
class ClassJsonToHtmlConverterTest {
    ...
    private static Stream<Arguments> validInputProvider() {
        ...
        return Stream.<Arguments>builder()
                .add(Arguments.of(json(null), ClassHtml.builder().classNameText(CLASS_NAME)
                        .stats(StatsHtml.builder().build())
                        .build()))
                .add(Arguments.of(json(Collections.emptyMap()), ClassHtml.builder().classNameText(CLASS_NAME)
                        .launches(Collections.emptyMap())
                        .stats(StatsHtml.builder().build())
                        .build()))
                .add(Arguments.of(full, ClassHtml.builder()
                        .classNameText(CLASS_NAME)
                        .countdown(StageLaunchStatsHtml.builder()
                                .displayName(COUNTDOWN)
                                .stats(StatsHtml.builder().build())
                                .build())
                        .launches(Collections.singletonMap(METHOD_NAME,
                                StageLaunchStatsHtml.builder()
