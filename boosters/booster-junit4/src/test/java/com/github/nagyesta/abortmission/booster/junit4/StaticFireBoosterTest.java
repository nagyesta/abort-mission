...
public class StaticFireBoosterTest {
    ...
    private static final String MESSAGE_FORMAT = "Error creating bean with name "
            + "'com.github.nagyesta.abortmission.booster.junit4.%s': "
            + "Unsatisfied dependency expressed through field 'sideBooster': Error creating bean "
            + "with name 'sideBooster' defined in com.github.nagyesta.abortmission.testkit.spring.StaticFire: "
            + "Failed to instantiate [com.github.nagyesta.abortmission.testkit.spring.Booster]: Factory method "
            + "'sideBooster' threw exception with message: Side boosters are not supported.";
